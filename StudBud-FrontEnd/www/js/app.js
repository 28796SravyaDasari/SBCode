...
angular.module('starter', ['ionic', 'angular.filter', 'ngIOS9UIWebViewPatch', 'starter.controllers', 'starter.services', 'ngMaterial', 'ngMessages', 'ngCordova', 'chart.js', 'checklist-model', 'ionic-datepicker'])
    .run(function ($ionicPlatform, $cordovaSQLite, $rootScope, $ionicHistory,$ionicPopup, $state,$http, $mdDialog, $mdBottomSheet) {
        ...
        $rootScope.$on('$stateChangeStart',
            function (event, toState, toParams, fromState, fromParams) {
                if (localStorage.getItem('Loginid') == undefined) {
                    ...
                    var pri = localStorage.getItem('privilege')
        ...
        if (localStorage.getItem('Loginid') == undefined)
            $rootScope.TeacherName = 'Teacher'
        else
            $rootScope.TeacherName = localStorage.getItem('TeacherName')
            
        $rootScope.checkAppUpdate=function(){
            var data = {
                Flag:'GetappversionTeacher'
            }
            $http({
                method: 'post'
                ...
                cordova.getAppVersion.getVersionNumber(function (version) {
                    if(response.data[0].version.toString()!=version.toString()){
                       //alert(response.data[0].version+','+version)
                        $rootScope.UpdateData=response.data[0] 
                    }
                    else
                    {
        ...
        $rootScope.checkAppUpdate();

        //if (navigator.connection.type == Connection.NONE) {
        //    $ionicPopup.confirm({
        //        title: "Internet Disconnected",
        //        content: "Internet seems to have gone away :( please connect to The Internet and Try Again"
        //    })
        ...
        //            content: "Location is disabled on your device :( or maybe you dont have permissions to access the location.Please enable location and try again."
        //        })
        //            .then(function (result) {
        //                if (result) {
        //                    ionic.Platform.exitApp();
        ...
        $ionicPlatform.ready(function () {
            ...
            window.plugins.OneSignal
              .startInit("766561e7-879d-4194-9e4f-039f7631a7de")
        ...
        $stateProvider
            ...
            .state('app.dashboard', {
               ...
               .state('app.home', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/material-user-interface/dashboard/html/home.html",
                        controller: 'dashboardCtrl'
                    }
                }
            })
            ...
            .state('app.attendance', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/application-storage/local-application-db/html/Attendence.html",
                        controller: 'noteListCtrl'
                    }
                }
            })
            ...
            .state('app.settings', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/menu/html/Settings.html",
                        controller: 'menuCtrl'
                    }
                }
            })
          ...
          .state('app.addattendance', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/application-storage/local-application-db/html/AddAttendence.html",
                        controller: 'noteListCtrl'
                    }
                }
            })
         .state('app.approvelist', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/application-storage/local-application-db/html/ApproveList.html",
                        controller: 'noteListCtrl'
                    }
                }
            })
            .state('app.mylists', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/application-storage/local-application-db/html/MyList.html",
                        controller: 'noteListCtrl'
            ...
            .state('app.notedetail', {
             ...
             .state('app.addnotice', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/application-storage/local-application-db/html/AddNotice.html",
                        controller: 'noteDetailCtrl'
                    }
                }
            })
             .state('app.materialupload', {
                url: "/materialupload",
                params: {
                    noteDetail: null,
                    actionDelete: false
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/application-storage/local-application-db/html/materialupload.html",
                        controller: 'noteDetailCtrl'
                    }
                }
            })
            .state('app.cloud', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/online-course/html/Cloud.html",
                        controller: 'dashboardCtrl'
                    }
                }
            })
            .state('app.syllabus', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/online-course/html/SyllabusManager.html",
                        controller: 'dashboardCtrl'
                    }
                }
            })
            .state('app.login', {
               ...
               .state('app.academic', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/online-course/html/AcademicYear.html",
                        controller: 'dashboardCtrl'
                    }
                }
            })
            .state('app.students', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/online-course/html/Students.html",
            ...
            .state('app.defaulters', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/online-course/html/Defaulters.html",
                        controller: 'locationCtrl'
                    }
                }
            })
        .state('app.autodefaulters', {
            url: "/autodefaulters",
            params: {
                noteDetail: null,
                actionDelete: false
            ...
            views: {
                'menuContent': {
                    templateUrl: "templates/themes/online-course/html/AutoDefaulters.html",
                    controller: 'locationCtrl'
                }
            }
        })
          ...
          //      views: {
          //          'menuContent': {
          //              templateUrl: "templates/themes/online-course/html/Maps.html",
          //              controller: 'dashboardCtrl'
          //          }
          //      }
          //})
          ...
          .state('app.notices', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/news-feed/html/notices.html",
                        controller: "teacherNoticeCtrl"
                    }
                }
            })
            .state('app.clothShop', {
           ...
           .state('app.lecture', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/online-course/html/Lectureplanning.html",
                        controller: 'dashboardCtrl'
                    }
                }
           })
             ...
             .state('app.StudentAttendance', {
                 ...
                 views: {
                     'menuContent': {
                         templateUrl: "templates/themes/online-course/html/StudentAttendance.html",
                         controller: 'dashboardCtrl'
                     }
                 }
             })
         ...
         .state('app.edittimetable', {
                url: "/edittimetable",
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/online-course/html/EditTimetable.html",
                        controller: 'dashboardCtrl'
                    }
                }
            })
